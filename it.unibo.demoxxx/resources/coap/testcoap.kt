...
lateinit var host   : String
	...
	private fun setClientForPath( path : String ){
		...
		println("testcoap | setClientForPath client=$client")
...
//	}
	...
	fun readResource(   path : String ){
		...
		println("	testcoap | readResource: $respGet  ")
	}
}

//fun main() = runBlocking{
//	testcoap.connect("coap://localhost:8077")
//// 	testcoap.readResource("example")
//  	testcoap.readResource("ctxblsledalone/led")
//}