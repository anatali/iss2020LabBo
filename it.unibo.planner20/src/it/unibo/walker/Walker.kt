		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t012",targetState="walk",cond=whenRequest("movetoCell"))
				}	 
				...
				state("execPlannedMoves") { //this:State
					action { //it:State
						...
						if(  CurrentPlannedMove.length > 0  
						 ){forward("doMove", "doMove($CurrentPlannedMove)" ,"walker" ) 
						}
						else
					 ...
					 transition(edgeName="t013",targetState="execTheMove",cond=whenDispatch("doMove"))
					transition(edgeName="t014",targetState="walk",cond=whenRequestGuarded("movetoCell",{ CurrentPlannedMove.length == 0  
					}))
				}	 
