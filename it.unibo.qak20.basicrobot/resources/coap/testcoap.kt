...
fun main() = runBlocking{
	testcoap.connect("coap://localhost:8018")
// 	testcoap.readResource("example")
  	testcoap.readResource("ctxbasicrobot/basicrobot")
  	testcoap.updateResource("ctxbasicrobot/basicrobot", "r")
  	testcoap.readResource("ctxbasicrobot/basicrobot")
  	testcoap.updateResource("ctxbasicrobot/basicrobot", "l")
}