...
set JARPATH=%APP_HOME%\lib\it.unibo.springbootIntro-0.0.1.jar

@rem Execute it.unibo.springbootIntro
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %IT_UNIBO_SPRINGBOOT_INTRO_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
