...
fun main() = runBlocking(){
	...
	val msg1 = AppMsg.buildDispatch("main","msg1","msg1_hello","demo")
	val msg2 = AppMsg.buildDispatch("main","msg2","msg2_hello","demo")
 	delay( 100 )
	Messages.forward(msg1, demo)
	delay( 100 )
	Messages.forward(msg1, demo)
	delay( 100 )
	Messages.forward(msg2, demo)
